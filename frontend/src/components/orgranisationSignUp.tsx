...
const OrganisationLoanForm: React.FC = () => { 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setError('');
    if (!formData.loanName || !formData.description) {
...
const OrganisationSignUpForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Replace '/organisationDashboard' with the actual path of the organization dashboard page
    } catch (err: any) {
