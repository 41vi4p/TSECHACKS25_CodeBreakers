...
const LoanSelectionPage = () => {
  const loans = [
    ...
    },
    {
      ...
      interestRate: "8.25%",
      description: "Fuel your business growth with our tailored business loans designed for entrepreneurs and SMEs.",
      terms: [
    ...
    },
    {
      ...
      interestRate: "5.50%",
      description: "Invest in your future with our education loan that covers both domestic and international studies.",
      terms: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {loans.map((loan, index) => (
            ...
            >
              ...
              {/* Action Button */}
              <button className="w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-medium rounded-lg transform transition-all duration-200 hover:scale-[1.02] focus:ring-2 focus:ring-blue-400">
                Apply Now
              </button>
            </div>
          ))}
...
export default LoanSelectionPage;